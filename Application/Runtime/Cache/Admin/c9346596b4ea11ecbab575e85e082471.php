...
<nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
  ...
  <script src="/imooc/Public/js/kindeditor/kindeditor-all.js"></script>
  <div id="page-wrapper">
...
<script>
  var SCOPE = {
    'save_url' : '/imooc/admin.php?c=content&a=add',
    'jump_url' : '/imooc/admin.php?c=content',
    'ajax_upload_image_url' : '/imooc/admin.php?c=image&a=ajaxuploadimage',
    'ajax_upload_swf' : '/imooc/Public/js/party/uploadify.swf',
  };

</script>
<!-- /#wrapper -->
<script src="/imooc/Public/js/admin/image.js"></script>
<script>
  // 6.2
  KindEditor.ready(function(K) {
    window.editor = K.create('#editor_singcms',{
      uploadJson : '/imooc/admin.php?c=image&a=kindupload',
