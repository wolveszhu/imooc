	...
	<div class="container-fluid">
	  ...
	  <div class="row">
		<div class="col-lg-12">
		  ...
		  <ol class="breadcrumb">
			<li>
			  <i class="fa fa-dashboard"></i>  <a href="/imooc/admin.php?c=positioncontent">推荐位内容管理</a>
			</li>
			<li class="active">
...
<script>
  var SCOPE = {
	'save_url' : '/imooc/admin.php?c=positioncontent&a=add',
	'jump_url' : '/imooc/admin.php?c=positioncontent&a=index',
