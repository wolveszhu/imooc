    ...
    <div class="container-fluid" >
        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <ol class="breadcrumb">
                    <li>
                        <i class="fa fa-dashboard"></i>  <a href="/imooc/admin.php?c=menu">菜单管理</a>
                    </li>
                    <li class="active">
        ...
        <!-- /.row -->
        <div class="row">
            <form action="/imooc/admin.php" method="get">
...
<script>
    ...
    var SCOPE = {
        'add_url' : '/imooc/admin.php?c=menu&a=add',
        'edit_url' : '/imooc/admin.php?c=menu&a=edit',
        'set_status_url' : '/imooc/admin.php?c=menu&a=setStatus',
        'listorder_url' : '/imooc/admin.php?c=menu&a=listorder',
    }
</script>
