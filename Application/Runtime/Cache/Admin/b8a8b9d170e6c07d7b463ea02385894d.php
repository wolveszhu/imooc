...
<script>
    var SCOPE = {
        'edit_url' : '/imooc/admin.php?c=positioncontent&a=edit',
        'set_status_url' : '/imooc/admin.php?c=positioncontent&a=setStatus',
        'add_url' : '/imooc/admin.php?c=positioncontent&a=add',
        'listorder_url' : '/imooc/admin.php?c=positioncontent&a=listorder',
    }
